...
case class OutputBaseNameAnnotation(outputBaseName: String) extends NoTargetAnnotation with MoSAICOption
...
case class LegacySFCAnnotation() extends NoTargetAnnotation with MoSAICOption
